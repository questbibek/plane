...
export const PROJECT_SETTINGS: Record<TProjectSettingsTabs, TProjectSettingsItem> = {
  ...
  custom_fields: {
    key: "custom_fields",
    i18n_label: "project_settings.custom_fields.title",
    href: `/custom-fields`,
    access: [EUserProjectRoles.ADMIN],
  ...
  jira_import: {
    key: "jira_import",
    i18n_label: "Import from Jira",
    href: `/jira-import`,
    access: [EUserProjectRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/jira-import/`,
  },
};
...
export const GROUPED_PROJECT_SETTINGS: Record<PROJECT_SETTINGS_CATEGORY, TProjectSettingsItem[]> = {
  ...
  [PROJECT_SETTINGS_CATEGORY.EXECUTION]: [PROJECT_SETTINGS["automations"], PROJECT_SETTINGS["jira_import"]],
};
